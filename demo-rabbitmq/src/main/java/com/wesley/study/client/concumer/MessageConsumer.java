package com.wesley.study.client.concumer;
...
public class MessageConsumer {
    ...
    public static void main(String[] args) throws IOException {
        ...
        AMQP.Queue.DeclareOk declareOk = channel.queueDeclare("wesley.order.add", true, false, false, new HashMap<>());
        ...
        channel.queueBind(declareOk.getQueue(), "wesley.order", "add", new HashMap<>());
