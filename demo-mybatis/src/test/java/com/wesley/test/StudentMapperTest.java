package com.wesley.test;

import com.wesley.growth.mybatis.entity.StudentEntity;
import com.wesley.growth.mybatis.mapper.ClassMapper;
import com.wesley.growth.mybatis.mapper.StudentMapper;
...
public class StudentMapperTest {
    ...
    public void testCacheWithUpdate() throws Exception {
        ...
        sqlSession3.commit();
        // 在sqlSession3更新数据库，并提交事务后，
        // sqlsession2的StudentMapper namespace下的查询走了数据库，没有走Cache。
        System.out.println("studentMapper2读取数据: " + studentMapper2.getStudentById(1));
    }
